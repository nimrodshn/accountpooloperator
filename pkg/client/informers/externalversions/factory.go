...
type SharedInformerFactory interface {
	...
	Accountpooloperator() accountpooloperator.Interface
}

func (f *sharedInformerFactory) Accountpooloperator() accountpooloperator.Interface {
	return accountpooloperator.New(f, f.namespace, f.tweakListOptions)
}
